...
✅ Versão Mobile
 ...
 Modal de publicação responsivo
...
Configurar o projeto para produção:
cd CreatorHubMobile
expo build:android
...
Atualizar app.json com informações da Play Store:
{
  "expo": {
    "name": "Creator Hub",
    "android": {
...
Teste o login (qualquer email/senha funciona)
Navegue pelo dashboard
Teste o modal de publicação
Teste o logout
Mobile
Execute expo start
Use o Expo Go app no seu celular
Escaneie o QR code
